...
const SEO = ({ title, description, keywords, image, url, type = 'website', schema }) => {
    ...
    const defaultImage = '/assets/logo.png'; // Update with actual default image path if available
    const siteUrl = 'https://tnt-pccc.com'; // Update with actual domain if known, or use window.location.origin
